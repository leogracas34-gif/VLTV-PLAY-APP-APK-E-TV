...
@Entity(tableName = "downloads", indices = [Index(value = ["status"]), Index(value = ["name", "season"]), Index(value = ["profile_name"])])
...
// ==========================================
// DATABASE — version 12 (profile_name em downloads, pra separar
// downloads do perfil Kids dos downloads do perfil adulto)
// ==========================================
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private fun buildDatabase(context: Context): AppDatabase {
            ...
            // por causa do novo campo "profile_name" e da mudança de versão
            // 11→12. Isso apaga downloads salvos localmente (o usuário vai
            // precisar baixar de novo o que já tinha baixado) e o catálogo
            // (vod_streams/series_streams), mas o catálogo resincroniza
            // sozinho na próxima abertura do app — mesmo comportamento já
