...
object DownloadHelper {
    ...
    fun baixarTemporadaCompleta(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                val msg = if (novosIniciados > 0)
                    "Baixando $novosIniciados episódio(s) da temporada $season..."
                else
                    "Todos os episódios dessa temporada já estão baixados."
