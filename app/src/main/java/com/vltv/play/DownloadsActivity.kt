...
class DownloadsActivity : AppCompatActivity() {
    ...
    // ✅ NOVO (correção do bug de downloads cruzando entre perfis): mesma
    // chave que DownloadHelper usa pra gravar o dono de cada download e
    // que ProfilesActivity grava ao entrar em um perfil. Lendo aqui na
    // hora de listar, garante que só aparecem os downloads do perfil
    // adulto que está ativo agora — nunca os do perfil Infantil.
    ...
    // ✅ NOVO: toque no card do filme (fora dos ícones de ação) sempre abre
    ...
    // ✅ NOVO: decide qual diálogo mostrar de acordo com o estado atual —
