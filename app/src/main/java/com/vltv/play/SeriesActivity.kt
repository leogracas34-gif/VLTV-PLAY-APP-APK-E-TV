    ...
    inner class SeriesCategoryAdapter(
        ...
        override fun onBindViewHolder(holder: VH, position: Int) {
            ...
            holder.tvName.setTextColor(
                holder.itemView.context.getColor(if (isSel) R.color.red_primary else R.color.gray_text)
            )
            holder.tvName.setBackgroundColor(if (isSel) 0xFF252525.toInt() else 0x00000000)
